...
import type { AgentId, AgentDriver } from "../src/drivers/types.js";
...
import { getRegisteredAgentIds, getDriver } from "../src/drivers/registry.js";
...
function makeDriver(detectResult: boolean | Error): AgentDriver {
  return {
    detect: detectResult instanceof Error
